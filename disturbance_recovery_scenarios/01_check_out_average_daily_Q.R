...
hydrohigh15 <- prep_model_data(hydrograph_list_high15, "q50 High Elevation (15%)") %>% rbind()
hydrolow30 <- prep_model_data(hydrograph_list_low30, "q50 Low Elevation (30%)") %>% rbind()
hydrolow15 <- prep_model_data(hydrograph_list_low15, "q50 Low Elevation (15%)") %>% rbind()

daily_average1 <- plot_average_daily(hydrohigh30, hydroaf)
daily_average2 <- plot_average_daily(hydrohigh15, hydroaf)
daily_average3 <- plot_average_daily(hydrolow30, hydroaf)
daily_average4 <- plot_average_daily(hydrolow15, hydroaf)

ggsave(daily_average1,
       filename = file.path(fig_path, "daily_average_high30.png"),
       units = "in",
       width = 5,
       height = 5)

ggsave(daily_average2,
       filename = file.path(fig_path, "daily_average_high15.png"),
       units = "in",
       width = 5,
       height = 5)

ggsave(daily_average3,
       filename = file.path(fig_path, "daily_average_low30.png"),
       units = "in",
       width = 5,
       height = )

ggsave(daily_average4,
       filename = file.path(fig_path, "daily_average_low15.png"),
       units = "in",
       width = 5,
       height = 5)
...
hydrograph_list <- hydrograph_list_all
